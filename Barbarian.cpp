...
//Default constructor
Barbarian::Barbarian(std::string charName):Character(charName)
{
  ...
  this->charName =  this->charName + " Barbarian";
...
{
  //Barbarian rolls two die, each with six sides.
  int attack = roll(2, 6);

  //Print 3.Attacker's attack dice roll.
...
{
  //Defense die roll for barbarian is two die with six sides.
